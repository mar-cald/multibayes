...
**multibayes** provides tools for Bayesian inference and decision-making across 
multiple hypotheses simultaneously. The package offers two  
functions rooted in different but related principles: `pd.adjust()` addresses 
