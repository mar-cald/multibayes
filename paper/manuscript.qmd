...
For simultanoues equi-tailed intervals `joint(interval = TRUE)`
```{r, echo=TRUE}
...
### Acknowledgements
We are grateful to Giovanni Parmigiani, Enrico Toffalini and Jelle Goeman for insightful comments and discussion throughout the development of this work. We also thank Laura Sità and Matteo Manente for helpful feedback on earlier versions of the manuscript.
