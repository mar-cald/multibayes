...
When the null distribution of $pd$ is approximately uniform on $[0.5, 1]$ (diffuse within-model prior or large $n$), the per-test probability of error is $\alpha^* = 2(1 - c^*)$; under an informative skeptical prior, which shrinks the posterior toward the null, this rate is even smaller. 
