...
addresses this problem by making the implicit prior probability of the
global null explicit.

The global prior probability that **all** hypotheses are null, *p*, is
